...
#include "rm_ros_interfaces/msg/toolframe.hpp"
...
/**********************************************初始化需要用到的回调函数***********************************************/
    ...
    void Set_Collision_Stage_Callback(const std_msgs::msg::UInt16::SharedPtr msg);                           //设置并回读碰撞检测等级
...
/************************************************************变量信息******************************************************/
    ...
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Set_Collision_Stage_Result;
    rclcpp::Publisher<std_msgs::msg::UInt16>::SharedPtr Collision_Stage_Result;
    ...
    rclcpp::Subscription<std_msgs::msg::UInt16>::SharedPtr Set_Collision_Stage_Cmd;
    ...
    /************************获取当前工具坐标系完整参数发布器************************/
    rclcpp::Publisher<rm_ros_interfaces::msg::Toolframe>::SharedPtr Get_Current_Tool_Frame_Data_Result;
    /*****************************************获取工具坐标系订阅器************************************/
